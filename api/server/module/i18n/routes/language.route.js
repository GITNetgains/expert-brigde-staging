...
module.exports = router => {
   ...
   * @apiPermission all
   */
  router.post('/v1/i18n/languages', Middleware.hasRole('admin'), languageController.create, Middleware.Response.success('create'));
   ...
   * @apiPermission all
   */
  router.put('/v1/i18n/languages/:languageId', Middleware.hasRole('admin'), languageController.update, Middleware.Response.success('update'));
   ...
   * @apiPermission all
   */
  router.delete('/v1/i18n/languages/:languageId', Middleware.hasRole('admin'), languageController.remove, Middleware.Response.success('remove'));
   ...
   * @apiPermission all
   */
  router.get('/v1/i18n/languages', Middleware.loadUser, languageController.list, Middleware.Response.success('list'));
};
