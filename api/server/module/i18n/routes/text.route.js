...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/i18n/text', Middleware.hasRole('admin'), textController.create, Middleware.Response.success('create'));
   ...
   * @apiPermission admin
   */
  router.put('/v1/i18n/text/:textId', Middleware.hasRole('admin'), textController.update, Middleware.Response.success('update'));
   ...
   * @apiPermission admin
   */
  router.delete('/v1/i18n/text/:textId', Middleware.hasRole('admin'), textController.remove, Middleware.Response.success('remove'));
