...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/i18n/translations', Middleware.hasRole('admin'), translationController.create, Middleware.Response.success('create'));
   ...
   * @apiPermission all
   */
  router.get('/v1/i18n/translations', Middleware.hasRole('admin'), translationController.list, Middleware.Response.success('list'));
   ...
   * @apiPermission admin
   */
  router.post('/v1/i18n/translations/:lang/pull', Middleware.hasRole('admin'), translationController.pull, Middleware.Response.success('pull'));
  /**
   * @apiGroup I18N
   * @apiVersion 4.0.0
   ...
   * @apiPermission all
   */
  router.get('/v1/i18n/:lang.json', translationController.sendJSON);
};
