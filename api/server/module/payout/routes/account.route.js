...
module.exports = router => {
   ...
   * @apiPermission tutor
   */
  router.post('/v1/payout/accounts', Middleware.isAuthenticated, accountController.create, Middleware.Response.success('create'));
   ...
   * @apiPermission tutor
   */
  router.get('/v1/payout/accounts', Middleware.isAuthenticated, accountController.list, Middleware.Response.success('list'));
};
