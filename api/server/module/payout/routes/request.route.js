...
module.exports = router => {
   ...
   * @api {post} /v1/payout/requests Send request
   * @apiParam {String}   payoutAccountId
   * @apiPermission tutor
   */
  router.post('/v1/payout/requests', Middleware.isAuthenticated, requestController.request, Middleware.Response.success('request'));
