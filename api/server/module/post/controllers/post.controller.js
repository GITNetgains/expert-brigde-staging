...
exports.create = async(req, res, next) => {
    try {
        ...
        let alias = req.body.alias ? Helper.String.createAlias(req.body.alias) : Helper.String.createAlias(req.body.title);
...
exports.update = async(req, res, next) => {
  try {
    ...
    req.post.alias = alias;
    if (typeof validate.value.meta !== 'undefined') {
      req.post.meta = validate.value.meta;
      req.post.markModified && req.post.markModified('meta');
    }
