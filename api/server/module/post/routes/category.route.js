...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/posts/categories', Middleware.hasRole('admin'), categoryController.create, Middleware.Response.success('postCategory'));
   ...
   * @apiPermission all
   */
  router.get('/v1/posts/categories/:id', categoryController.findOne, Middleware.Response.success('postCategory'));
   ...
   * @apiPermission all
   */
  router.get('/v1/posts/categories', categoryController.list, Middleware.Response.success('list'));
};
