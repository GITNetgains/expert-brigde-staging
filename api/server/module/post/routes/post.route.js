...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/posts', Middleware.hasRole('admin'), postController.create, Middleware.Response.success('post'));
   ...
   * @apiPermission admin
   */
  router.put('/v1/posts/:id', Middleware.hasRole('admin'), postController.findOne, postController.update, Middleware.Response.success('update'));
   ...
   * @apiPermission all
   */
  router.get('/v1/posts/:id', postController.findOne, Middleware.Response.success('post'));
   ...
   * @apiPermission all
   */
  router.get('/v1/posts', postController.list, Middleware.Response.success('list'));
};
