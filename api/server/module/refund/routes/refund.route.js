...
module.exports = router => {
   ...
   * @apiPermission tutor
   */
  router.post('/v1/refund/request', Middleware.isAuthenticated, refundController.request, Middleware.Response.success('request'));
   ...
   */
  router.get('/v1/refund/requests', Middleware.isAuthenticated, refundController.list, Middleware.Response.success('list'));
