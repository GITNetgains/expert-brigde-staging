...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/testimonials', Middleware.hasRole('admin'), testimonialController.create, Middleware.Response.success('testimonial'));
   ...
   * @apiPermission all
   */
  router.get('/v1/testimonials/:testimonialId', testimonialController.findOne, Middleware.Response.success('testimonial'));
