...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/grades', Middleware.hasRole('admin'), gradeController.create, Middleware.Response.success('grade'));
   ...
   * @apiPermission all
   */
  router.get('/v1/grades/:gradeId', gradeController.findOne, Middleware.Response.success('grade'));
   ...
   * @apiPermission all
   */
  router.get('/v1/grades', gradeController.list, Middleware.Response.success('list'));
};
