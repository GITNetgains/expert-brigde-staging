...
module.exports = router => {
   ...
   * @apiPermission admin
   */
  router.post('/v1/subjects', Middleware.hasRole('admin'), subjectController.create, Middleware.Response.success('subject'));
   ...
   * @apiPermission all
   */
  router.get('/v1/subjects/:subjectId', subjectController.findOne, Middleware.Response.success('subject'));
   ...
   * @apiPermission all
   */
  router.get('/v1/subjects', subjectController.list, Middleware.Response.success('list'));
};
