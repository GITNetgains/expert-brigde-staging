...
module.exports = router => {
  ...
  //  */
  router.post('/v1/connect/facebook', Middleware.isAuthenticated, connectController.connectFacebook, Middleware.Response.success('connect'));
  ...
  //  * @apiPermission Authenticated user
  //  */
  router.post('/v1/connect/google', Middleware.isAuthenticated, connectController.connectGoogle, Middleware.Response.success('connect'));
};
