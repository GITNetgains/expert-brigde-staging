...
const verifyCaptcha = require('../middlewares/verifyCaptcha.js');
...
router.post(
  ...
  Middleware.Response.success('checkEmailAndSubmit')
     ...
     * @apiVersion 4.0.0
     *
     * @api {put} /v1/users/:id/change-email Change Email
     * @apiPermission authenticated user
     *
     * @apiDescription Change the email address of the authenticated user.
     *
     * @apiParam {String} email New email address.
     *
     * @apiSuccess {Object} changeEmail Change email success status.
     *
