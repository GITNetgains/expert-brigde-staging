export const tutorMenus = [
  ...
  description: 'Explore new opportunities, collaborations, and growth options.',
  path: 'https://opportunities.expertbridge.co/opportunities',
  key: 'menu-new-opportunities'
},
  {
...
export const studentMenus = [
  {
    ...
    description: 'Provide a one line brief – our AI drafts your query - post in seconds',
    path: null,
    key: 'menu-submit-new-project'
  },
  {
    icon: 'fi fi-rr-users',
    title: 'Assigned Experts',
    description: 'View the experts assigned to your projects.',
    path: '/experts',
    key: 'menu-assigned-experts'
  },
  {
    icon: 'fi fi-rr-calendar',
    title: 'Upcoming Appointments',
  ...
  },
  {
    ...
    title: 'Live Projects',
    description: 'View your active AI query projects.',
  ...
  },
  {
    ...
    description: 'Browse group sessions from experts. Filter by category and subcategory.',
